...
function Toast2(_a) {
  ...
  return /* @__PURE__ */ jsxs4(ToastUI.Provider, { swipeDirection: "right", children: [
    /* @__PURE__ */ jsxs4(ToastContainer, __spreadProps(__spreadValues({ open }, props), { children: [
      /* @__PURE__ */ jsx5(Title2, { as: "h2", children: title }),
      /* @__PURE__ */ jsx5(Description2, { as: "span", children: description }),
      /* @__PURE__ */ jsx5(CloseButton, { asChild: true, children: /* @__PURE__ */ jsx5(X, { size: 20 }) })
    ] })),
...
function Tooltip2(_a) {
  ...
  return /* @__PURE__ */ jsx6(TooltipUI.Provider, { children: /* @__PURE__ */ jsxs5(TooltipUI.Root, __spreadProps(__spreadValues({}, props), { children: [
    /* @__PURE__ */ jsx6(TooltipUI.Trigger, { asChild: true, children }),
    /* @__PURE__ */ jsx6(TooltipUI.Portal, { children: /* @__PURE__ */ jsxs5(Content2, { sideOffset: 5, children: [
      content,
